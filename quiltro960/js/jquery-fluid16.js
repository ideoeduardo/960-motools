...
Ajax : function(){
	...
	$("#toggle-ajax").bind("click", function(e) {
        if ( $(this).is(".hidden") ) {
            ...
            $("#loading").show();
            $("#ajax-content").load("quiltro960/data/ajax-response.html", function() {
            	$("#loading").hide();
            	content.slideDown();
            });
        }
		  ...
		  Kwicks : function(){
			  ...
			  $("#kwick .kwick")
				  .bind("mouseenter", function(e) {
					  ...
					  animating == true;
					  $("#kwick .kwick").not(this).animate({ "width": 80 }, 160);
					  $(this).animate({ "width": 150 }, 160, function() {
						  animating = false;
					  });
				  });
			  $("#kwick").bind("mouseleave", function(e) {
				  $(".kwick", this).animate({ "width": 87 }, 160);
			  });
		  },
